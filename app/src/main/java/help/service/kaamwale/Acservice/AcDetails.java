...
public class AcDetails extends AppCompatActivity {
    ...
    MaterialCardView ac1,card1,card2;
    RadioGroup rdg;
    Button bs,next;
    TextView txtvw;
    ScrollView scrollView;
    EditText editTextcity,editTextpostal,editTextnearby,editTextstreet,editTextsociety;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bs.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                Toast.makeText(AcDetails.this, "Please Select Any One Option !",Toast.LENGTH_SHORT).show();
            } else {
        ...
        editTextsociety = findViewById(R.id.Society);
        editTextstreet = findViewById(R.id.street);
        editTextpostal = findViewById(R.id.postal);
        editTextnearby = findViewById(R.id.nearby);
        editTextcity = findViewById(R.id.city);
        txtvw = findViewById(R.id.txtvw1);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            private void Submit() {
                ...
                if(street.isEmpty()){
                    ...
                    Intent intent= new Intent(AcDetails.this, AcFinalPage.class);
                ...
                Intent intent = new Intent(getApplicationContext() , AcFinalPage.class);
